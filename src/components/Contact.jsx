...
const ContactUs = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black p-6">
      <h1 className="text-5xl font-extrabold text-yellow-400 text-center mb-4 drop-shadow-lg">Get in Touch</h1>
      ...
      <div className="bg-yellow-500 p-10 rounded-2xl shadow-2xl max-w-lg w-full border-4 border-yellow-300">
        ...
        <form className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-white text-yellow-500 font-bold p-4 rounded-lg hover:bg-yellow-300 hover:text-white transition transform hover:scale-105 shadow-lg"
          >
            Send Message
          </button>
        </form>
